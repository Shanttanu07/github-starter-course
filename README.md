...
Since its birth in 2005, Git has evolved and matured to be easy to use and yet retain these initial qualities. It’s amazingly fast, it’s very efficient with large projects, and it has an incredible branching system for non-linear development (see read ["Git Branching"] (https://git-scm.com/book/en/v2/ch00/ch03-git-branching)).
*Ref:*read["link"](https://git-scm.com/book/en/v2/Getting-Started-A-Short-History-of-Git)
